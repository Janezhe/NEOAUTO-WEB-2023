<x-layouts.app title="¿Te gustan los autos? Aprende sobre los hatchbacks en esta breve historia - TUAUTOpe">
    <link rel="stylesheet" href="{{asset('css/noticia.css')}}">
    <link rel="stylesheet" href="{{asset('css/Noticia2.css')}}"> 
    <link rel="stylesheet" href="{{asset('css/noticia3.css')}}">
    <x-Noticias.VN_hatchback_breve_historia />
