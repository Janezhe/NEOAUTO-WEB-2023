                ...
                <section id="main-content" class="section-content">
                    ...
                    <ul class="article-list">
                        <li class="article-list-item ">
                            <a href="{{route('compra_segura')}}" class="article-list-link">Consejos para una compra segura del vehículo </a>
                        </li>
                        <li class="article-list-item ">
                            <a href="{{route('busco_vehiculo')}}" class="article-list-link">¿Cómo busco vehículos en NeoAuto?</a>
                        </li>
                        <li class="article-list-item ">
                            <a href="{{route('contacto_vendedor')}}" class="article-list-link">¿Como contacto al Vendedor?</a>
                        </li>
                        <li class="article-list-item ">
                            <a href="{{route('Cambio')}}" class="article-list-link">¿Cómo cambio la contraseña?</a>
                        </li>
                        <li class="article-list-item ">
                            <a href="{{route('recuperar')}}" class="article-list-link">¿Cómo recuperar mi contraseña?</a>
                        </li>
                    </ul>
                </section>
            </div>
